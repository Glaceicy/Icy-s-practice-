...
question bank, playable end to end) — **13 of the 100 levels**:
...
Every one of these 13 levels' templates is individually verified (by
...
**The other 87 levels** have their objectives fully defined but no lessons
...
per-template by the tests) but only for these 13 levels; it is not a claim
