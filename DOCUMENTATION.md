...
question bank, playable end to end) — **14 of the 100 levels**:
...
Every one of these 14 levels' templates is individually verified (by
...
**The other 86 levels** have their objectives fully defined but no lessons
...
per-template by the tests) but only for these 14 levels; it is not a claim
