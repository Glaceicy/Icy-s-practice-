...
question bank, playable end to end) — **19 of the 100 levels**:
...
Every one of these 19 levels' templates is individually verified (by
...
**The other 81 levels** have their objectives fully defined but no lessons
...
per-template by the tests) but only for these 19 levels; it is not a claim
