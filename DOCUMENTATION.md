...
question bank, playable end to end) — **12 of the 100 levels**:
...
Every one of these 12 levels' templates is individually verified (by
...
**The other 88 levels** have their objectives fully defined but no lessons
...
per-template by the tests) but only for these 12 levels; it is not a claim
