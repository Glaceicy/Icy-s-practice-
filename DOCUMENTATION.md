...
question bank, playable end to end) — **18 of the 100 levels**:
...
Every one of these 18 levels' templates is individually verified (by
...
**The other 82 levels** have their objectives fully defined but no lessons
...
per-template by the tests) but only for these 18 levels; it is not a claim
