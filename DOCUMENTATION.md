...
question bank, playable end to end) — **15 of the 100 levels**:
...
Every one of these 15 levels' templates is individually verified (by
...
**The other 85 levels** have their objectives fully defined but no lessons
...
per-template by the tests) but only for these 15 levels; it is not a claim
