...
// Year 7 (ages 11-12, KS3). Level 1 is fully authored (lessons, practice,
// 40-question mastery bank); levels 2-10 are scaffolded (curriculum metadata
// only — see questionEngine/templates/all.ts COMPLETE_LEVEL_KEYS). KS3
// mathematics is not broken into individual school years by the
...
export const year7: SchoolYearDef = {
  ...
  levels: [
    ...
    { levelNumber: 3, title: "Fractions and mixed numbers", summary: "By the end of this level, you will add, subtract, multiply and divide fractions and mixed numbers.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 4, title: "Decimals, percentages and conversions", summary: "By the end of this level, you will convert fluently between fractions, decimals and percentages.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 5, title: "Ratio, proportion and scale", summary: "By the end of this level, you will solve problems involving ratio, proportion and scale diagrams.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 6, title: "Algebraic notation and simplifying expressions", summary: "By the end of this level, you will use algebraic notation and simplify expressions.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 7, title: "Equations and number sequences", summary: "By the end of this level, you will solve linear equations and continue number sequences.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 8, title: "Angles, constructions and properties of shapes", summary: "By the end of this level, you will calculate angles and construct shapes accurately.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 9, title: "Perimeter, area, volume, graphs and data", summary: "By the end of this level, you will calculate area/volume and interpret graphs and data.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 10, title: "Year 7 mixed mastery", summary: "By the end of this level, you will confidently use everything you have learned in Year 7.", isMixedMastery: true, status: "SCAFFOLDED", pathway: null, objectives: [
