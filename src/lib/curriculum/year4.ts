...
// Year 4 (ages 8-9, KS2). Level 1 is fully authored (lessons, practice,
// 40-question mastery bank); levels 2-10 are scaffolded (curriculum metadata
// only — see questionEngine/templates/all.ts COMPLETE_LEVEL_KEYS). Grounded
// in the DfE National Curriculum Key Stage 2 Year 4 programme of study.
export const year4: SchoolYearDef = {
  ...
  levels: [
    ...
    { levelNumber: 3, title: "Multiplication tables up to 12 x 12", summary: "By the end of this level, you will recall all multiplication and division facts up to 12x12.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 4, title: "Written multiplication and division", summary: "By the end of this level, you will multiply two- and three-digit numbers by a one-digit number.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 5, title: "Fractions and equivalent fractions", summary: "By the end of this level, you will recognise, compare and add fractions.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 6, title: "Decimals and decimal place value", summary: "By the end of this level, you will read, write and compare decimals with up to two decimal places.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 7, title: "Measurement, conversion, perimeter and area", summary: "By the end of this level, you will convert units and find the area and perimeter of rectangles.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 8, title: "Angles, symmetry, shapes and coordinates", summary: "By the end of this level, you will classify angles and shapes and use coordinates.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 9, title: "Statistics, tables and charts", summary: "By the end of this level, you will interpret and present data in charts and tables.", isMixedMastery: false, status: "SCAFFOLDED", pathway: null, objectives: [
    ...
    { levelNumber: 10, title: "Year 4 mixed mastery", summary: "By the end of this level, you will confidently use everything you have learned in Year 4.", isMixedMastery: true, status: "SCAFFOLDED", pathway: null, objectives: [
